...
public class AdapterPembayaran extends RecyclerView.Adapter<AdapterPembayaran.MyViewHolder> {
    ...
    public AdapterPembayaran(List<ListPembayaran> pembayaranList, Context mContext) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.data_pembayaran, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, final int i) {
        ...
        myViewHolder.btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                p.deletePembayaran(mContext, pembayaranList.get(i).getId_pembayaran());
            }
        });
    }
