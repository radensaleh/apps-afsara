...
public class DataPasienActivity extends AppCompatActivity {
    ...
    private EditText et_idPasien, et_nama, et_alamat, et_noHP, et_pswd;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id){
            case R.id.action_add:
                ...
                dialog = new AlertDialog.Builder(DataPasienActivity.this);
                inflater = getLayoutInflater();
                dialogView = inflater.inflate(R.layout.activity_add_pasien, null);
                ...
                btnDate.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        DatePickerDialog datePickerDialog = new DatePickerDialog(DataPasienActivity.this,
                ...
                et_idPasien = dialogView.findViewById(R.id.et_idPasien);
                ...
                dialog.setNegativeButton("Add", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if(TextUtils.isEmpty(et_idPasien.getText())){
                            ...
                            String id_pasien = et_idPasien.getText().toString().trim();
                            ...
                            pasien.addPasien(id_pasien,password,nama,jk,date,alamat,no_hp,status,pd,mContext);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.recyclerPasien);
        ...
        pasien.showPasien(recyclerView, mContext);
//
